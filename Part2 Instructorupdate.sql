...
AS
  ...
  IF (SELECT COUNT(*) FROM Instructors i WHERE i.Ins_Id =@id) = 0
          ...
          ELSE  SELECT('this instructor is already exists')
	   ...
	   BEGIN CATCH
		...
		END CATCH
	 ------calling Insert   ---------
EXEC addINSTRUCTOR  16,asmaa,roshsy,22,'asma@gmail.com',elshona,mansoura,122897,asma999,4000,20
...
END
-----calling Update ------
EXEC UpdateInstructor 15,'suzan','marawan',26,'laian@gmail.com',elketan,cairo,211185,lail256,7800,40
